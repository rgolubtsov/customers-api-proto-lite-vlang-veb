...
> Since V is still in beta state and changing continuously, this project is currently developed using the version ~~(and the last build commit)~~ of V given above, from 20th of March, 2025.
